---
title: Cart Service - Rate Limiting Misconfiguration
date: 2024-06-29
severity: P1
...
## Summary
On 2024-06-29, the cart-service experienced rate limiting misconfiguration leading to service degradation.
...
## Root Cause
The cart-service was experiencing rate limiting misconfiguration due to misconfiguration in the deployment.
