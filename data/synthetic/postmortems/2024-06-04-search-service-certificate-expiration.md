---
title: Search Service - Certificate Expiration
date: 2024-06-04
severity: P0
...
## Summary
On 2024-06-04, the search-service experienced certificate expiration leading to service degradation.
...
## Root Cause
The search-service was experiencing certificate expiration due to misconfiguration in the deployment.
